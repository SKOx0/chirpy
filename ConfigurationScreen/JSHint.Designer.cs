namespace Zippy.Chirp.ConfigurationScreen
{
    partial class JSHint
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.panel1.Controls.Add(this.TxtMaxerr);
            this.panel1.Controls.Add(this.chkWhite);
            this.panel1.Controls.Add(this.chkUndef);
            this.panel1.Controls.Add(this.chkSub);
            this.panel1.Controls.Add(this.chkStrict);
            this.panel1.Controls.Add(this.chkRegex);
            this.panel1.Controls.Add(this.chkPlusPlus);
            this.panel1.Controls.Add(this.chkPassfail);
            this.panel1.Controls.Add(this.chkNoVar);
            this.panel1.Controls.Add(this.chkNoNew);
            this.panel1.Controls.Add(this.chkNomen);
            this.panel1.Controls.Add(this.chkNoEmpty);
            this.panel1.Controls.Add(this.chkNoArg);
            this.panel1.Controls.Add(this.chkNewcap);
            this.panel1.Controls.Add(this.chkAsi);
            this.panel1.Controls.Add(this.chkLaxbreak);
            this.panel1.Controls.Add(this.chkBitwise);
            this.panel1.Controls.Add(this.chkImmed);
            this.panel1.Controls.Add(this.chkBoss);
            this.panel1.Controls.Add(this.chkForin);
            this.panel1.Controls.Add(this.chkCurly);
            this.panel1.Controls.Add(this.chkEvil);
            this.panel1.Controls.Add(this.chkDebug);
            this.panel1.Controls.Add(this.chkEqnull);
            this.panel1.Controls.Add(this.chkEqeqeq);
